...
14. 项目底层框架(UI、网络等)，做过哪些优化
    1. UI 的脏标记刷新。
    2. protobuf 对象池。

15. 加载ab到实例化一个游戏物体的具体过程
...
25. Drawcall（怎么降低，本质，优化-ugui怎么优化drawcall）
    1. 动态合批，静态合批。
    2. UGUI中减少元素叠加。
...
33. Unity C#代码优化
    ...
    3. 减少闭包的形成
34. UGUI Image 的渲染流程（怎么渲染出来的）
    1. 参考： https://zhuanlan.zhihu.com/p/343524911
35. Box2D 中物理碰撞检测算法，怎么分区检测
...
54. 几种图片压缩格式，分别用在什么情况下，效率如何，效果如何
